"""Delivery-specific context construction - a thin convenience layer over
...
def build_delivery_context(agent_context: AgentContext, request: SpecialistRequest) -> SpecialistContext:
