"""Insight-specific context construction - a thin convenience layer over
SpecialistContext (app.services.ai.agents.specialists.shared.context),
never a parallel context type. Identical in shape and purpose to
build_personal_intelligence_context()/build_research_context().
"""
...
def build_insight_context(agent_context: AgentContext, request: SpecialistRequest) -> SpecialistContext:
